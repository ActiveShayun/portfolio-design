...
const Banner = () => {
    return (
        <div className='lg:px-9 lg:py-[135px] py-12 relative mb-12 lg:mt-0  bg-gradient-to-bl from-sky-100 via-lime-300 to-white opacity-80 rounded-lg h-[600px] w-full'>
            <div>
                <BannerTitle />
            </div>
            {/* bottom section */}
